## Object Oriented Programming Slides -- BASH Overview
...
## Installation
 ...
 ```sh
 $ git clone https://github.com/objetos/bash.git
 $ cd bash
...
3. Install dependencies (you must be already on the presentation folder, otherwise ```$ cd bash```)
